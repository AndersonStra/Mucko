...
class V7WTestDataset(Dataset):
    def __init__(self, config, overfit=False, in_memory=True):
        ...
        # with h5py.File('/home/data1/yjgroup/data_zzh/visual7w_kb/img_feature.hdf5', 'r') as f:
        #     image_ids = list(f['image_ids'])
        #     image_features = f['image_features']
        #     image_relations = f['image_relations']

        # image_h5path = '/home/data1/yjgroup/data_zzh/visual7w_kb/img_feature.hdf5'
        # self.hdf_reader = ImageFeaturesHdfReader(image_h5path, in_memory)
